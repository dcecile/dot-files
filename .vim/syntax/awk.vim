...
"
" NOTE: Without annoying array accessor highlihgting
if version < 600
  syn clear
...
" Custom
syn keyword awkVariables	true false use check
...
syn region	awkParen	transparent start="(" end=")" contains=ALLBUT,awkParenError,awkSpecialCharacter,awkArrayArray,awkTodo,awkRegExp,awkBrktRegExp,awkBrackets,awkCharClass
...
syn region awkArray		transparent start="\[" end="\]"
